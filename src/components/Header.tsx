        ...
        <div className="flex items-center justify-between gap-2 sm:gap-4">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 md:gap-3">
            ...
            <Button variant="cart" onClick={onCartClick} className="relative px-2 sm:px-4 h-9 sm:h-10">
              ...
              {cartItemsCount > 0 && <span className="absolute -top-1 -right-1 sm:-top-2 sm:-right-2 bg-destructive text-destructive-foreground rounded-full w-5 h-5 sm:w-6 sm:h-6 text-[10px] sm:text-xs flex items-center justify-center animate-pulse-soft font-bold">
                  {cartItemsCount}
                </span>}
            </Button>
          </div>
