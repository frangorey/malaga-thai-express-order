...
const translations = {
  es: {
    ...
    'error_variant_not_found': 'No encontramos esa variante. Inténtalo de nuevo.',
    'error_loading_variants': 'No pudimos cargar las variantes. Recarga la página.',
    ...
    'salad_protein_chicken': 'Con pollo',
    'salad_protein_chicken_desc': 'Ensalada con pollo tierno',
    'salad_protein_shrimp': 'Con langostino',
    ...
    'world_pollo_coreano_card': 'Pollo Coreano',
    'world_pad_ka_prao_card': 'Pad Ka Prao',
    'padkaprao_choose_protein': 'Elige tu proteína',
    'world_curry_pina_card': 'Arroz Curry y Piña',
    'tonkatsu_choose_garnish': 'Elige tu guarnición',
    'tonkatsu_garnish_fried_rice': 'Arroz Frito',
    'tonkatsu_garnish_fried_noodles': 'Fideos Fritos',
    'tonkatsu_choose_sauce': 'Elige tu salsa',
    'tonkatsu_sauce_sweet_sour': 'Agridulce',
    'tonkatsu_sauce_bbq': 'Barbacoa',
    'korean_chicken_choose_garnish': 'Elige tu guarnición',
    'korean_chicken_garnish_white_rice': 'Arroz Blanco',
    'korean_chicken_garnish_japanese_rice': 'Arroz Japonés',
    'korean_chicken_garnish_fries': 'Patatas Fritas',
    'korean_chicken_choose_sauce': 'Elige tu salsa',
    'korean_chicken_sauce_sweet_sour': 'Agridulce',
    'korean_chicken_sauce_honey_mustard': 'Miel Mostaza',
    'korean_chicken_sauce_yogurt': 'Yogur',
    'salad_choose_protein': 'Elige tu proteína',
    'salad_protein_veggie': 'Vegetariana (sin proteína animal)',
    'salad_protein_mix': 'Mixta: pollo + langostino',
    'salad_cesar_card': 'Ensalada César',
    'salad_classic_card': 'Ensalada Classic',
    'salad_crispy_card': 'Ensalada Crispy',
    'salad_fruta_card': 'Ensalada de Fruta',
    'salad_malaysia_card': 'Ensalada Malaysia',
    'salad_thailandia_card': 'Ensalada Tailandia',
    ...
    'rice_fried_card': 'Arroz Frito',
    'rice_curry_card': 'Arroz Curry',
  ...
  en: {
    ...
    'error_variant_not_found': "We couldn't find that variant. Please try again.",
    'error_loading_variants': "We couldn't load the variants. Please reload the page.",
    ...
    'salad_protein_chicken': 'With chicken',
    'salad_protein_chicken_desc': 'Salad with tender chicken',
    'salad_protein_shrimp': 'With prawn',
    ...
    'world_tonkatsu_card': 'Tonkatsu',
    'world_pollo_coreano_card': 'Korean Chicken',
    'world_pad_ka_prao_card': 'Pad Ka Prao',
    'padkaprao_choose_protein': 'Choose your protein',
    'world_curry_pina_card': 'Curry & Pineapple Rice',
    'tonkatsu_choose_garnish': 'Choose your side',
    'tonkatsu_garnish_fried_rice': 'Fried Rice',
    'tonkatsu_garnish_fried_noodles': 'Fried Noodles',
    'tonkatsu_choose_sauce': 'Choose your sauce',
    'tonkatsu_sauce_sweet_sour': 'Sweet & Sour',
    'tonkatsu_sauce_bbq': 'Barbecue',
    'korean_chicken_choose_garnish': 'Choose your side',
    'korean_chicken_garnish_white_rice': 'White Rice',
    'korean_chicken_garnish_japanese_rice': 'Japanese Rice',
    'korean_chicken_garnish_fries': 'French Fries',
    'korean_chicken_choose_sauce': 'Choose your sauce',
    'korean_chicken_sauce_sweet_sour': 'Sweet & Sour',
    'korean_chicken_sauce_honey_mustard': 'Honey Mustard',
    'korean_chicken_sauce_yogurt': 'Yogurt',
    'salad_choose_protein': 'Choose your protein',
    'salad_protein_veggie': 'Vegetarian (no animal protein)',
    'salad_protein_mix': 'Mix: chicken + prawn',
    'salad_cesar_card': 'Caesar Salad',
    'salad_classic_card': 'Classic Salad',
    'salad_crispy_card': 'Crispy Salad',
    'salad_fruta_card': 'Fruit Salad',
    'salad_malaysia_card': 'Malaysian Salad',
    'salad_thailandia_card': 'Thai Salad',
    ...
    'rice_fried_card': 'Fried Rice',
    'rice_curry_card': 'Curry Rice',
  ...
  fr: {
    ...
    'error_variant_not_found': "Nous n'avons pas trouvé cette variante. Réessaie.",
    'error_loading_variants': 'Impossible de charger les variantes. Recharge la page.',
    ...
    'salad_protein_chicken': 'Au poulet',
    'salad_protein_chicken_desc': 'Salade avec poulet tendre',
    'salad_protein_shrimp': 'Aux crevettes',
    ...
    'tonkatsu_garnish_fried_noodles': 'Nouilles Sautées',
    'tonkatsu_choose_sauce': 'Choisissez votre sauce',
    'tonkatsu_sauce_sweet_sour': 'Aigre-douce',
    'tonkatsu_sauce_bbq': 'Barbecue',
    'korean_chicken_choose_garnish': 'Choisissez votre garniture',
    'korean_chicken_garnish_white_rice': 'Riz Blanc',
    'korean_chicken_garnish_japanese_rice': 'Riz Japonais',
    'korean_chicken_garnish_fries': 'Frites',
    'korean_chicken_choose_sauce': 'Choisissez votre sauce',
    'korean_chicken_sauce_sweet_sour': 'Aigre-douce',
    'korean_chicken_sauce_honey_mustard': 'Miel Moutarde',
    'korean_chicken_sauce_yogurt': 'Yaourt',
    'salad_choose_protein': 'Choisissez votre protéine',
    'salad_protein_veggie': 'Végétarienne (sans protéine animale)',
    'salad_protein_mix': 'Mix : poulet + crevettes',
    'salad_cesar_card': 'Salade César',
    'salad_classic_card': 'Salade Classique',
    'salad_crispy_card': 'Salade Crispy',
    'salad_fruta_card': 'Salade de Fruits',
    'salad_malaysia_card': 'Salade Malaisienne',
    'salad_thailandia_card': 'Salade Thaï',
    ...
    'table': 'Table',
    'ordering_from_table': 'Vous commandez depuis la Table',
    ...
    'notes_placeholder': 'Sans oignon, extra piquant, etc...',
    'processing': 'TRAITEMENT...',
    'order_to_table': 'COMMANDER À LA TABLE',
    'place_order': 'PASSER COMMANDE',
    'pay_at_restaurant': 'Payez au restaurant en récupérant votre commande',
    'order_sent_to_kitchen': 'Votre commande sera envoyée directement en cuisine · Payez le serveur',
    'service_unavailable': 'Service non disponible',
    'service_unavailable_desc': 'Ce service est temporairement désactivé, nous avons uniquement le service à emporter au restaurant',
    'order_received': 'Votre commande a été reçue et est en préparation.',
    'order_received_table': 'Votre commande pour la Table {table} a été reçue.',
    'order_processed': 'Commande traitée !',
    'order_notify': 'Nous vous préviendrons quand elle sera prête.',
    'order_error': 'Un problème est survenu lors du traitement de votre commande. Veuillez réessayer.',
    'cart_empty_error': 'Le panier est vide',
    'select_order_type': 'Veuillez sélectionner le type de commande',
    'your_full_name': 'Votre nom complet',
    'phone_placeholder': 'Numéro de téléphone',
    'customize': 'Personnaliser',
    'from_price': 'À partir de 10,60€',
    'variant_edamame': 'Edamame',
    'variant_edamame_spicy': 'Edamame Piquant (+0,20€)',
    'variant_fried': 'Frites',
    'variant_grilled': 'Grillées',
    'variant_1_unit': '1 unité',
    'variant_2_units': '2 unités',
    'variant_gyozas': 'Gyozas aux crevettes (6 pcs)',
    'variant_pinchito_shrimp': 'Brochette de crevettes',
    'variant_pinchito_chicken': 'Brochette de poulet',
    'soup_chicken_label': 'Poulet',
    'soup_prawn_label': 'Crevette',
    'soup_veggie_label': 'Végétarien',
    'noodles_pad_thai': 'Pad Thai (Larges)',
    'noodles_finos_card': 'Nouilles (Fines)',
    'noodles_glass_card': 'Glass',
    'noodles_udon_card': 'Udon',
    'rice_fried_thai': 'Riz Frit Thaï',
    'rice_fried_card': 'Riz Sauté',
    'rice_curry_card': 'Riz au Curry',
  ...
  de: {
    ...
    'error_variant_not_found': 'Wir konnten diese Variante nicht finden. Bitte versuche es erneut.',
    'error_loading_variants': 'Die Varianten konnten nicht geladen werden. Bitte lade die Seite neu.',
    ...
    'salad_protein_chicken': 'Mit Hähnchen',
    'salad_protein_chicken_desc': 'Salat mit zartem Hähnchen',
    'salad_protein_shrimp': 'Mit Garnelen',
    ...
    'world_tonkatsu_card': 'Tonkatsu',
    'world_pollo_coreano_card': 'Koreanisches Hähnchen',
    'world_pad_ka_prao_card': 'Pad Ka Prao',
    'padkaprao_choose_protein': 'Wähle dein Protein',
    'world_curry_pina_card': 'Curry-Reis mit Ananas',
    'tonkatsu_choose_garnish': 'Wähle deine Beilage',
    'tonkatsu_garnish_fried_rice': 'Gebratener Reis',
    'tonkatsu_garnish_fried_noodles': 'Gebratene Nudeln',
    'tonkatsu_choose_sauce': 'Wähle deine Soße',
    'tonkatsu_sauce_sweet_sour': 'Süßsauer',
    'tonkatsu_sauce_bbq': 'Barbecue',
    'korean_chicken_choose_garnish': 'Wähle deine Beilage',
    'korean_chicken_garnish_white_rice': 'Weißer Reis',
    'korean_chicken_garnish_japanese_rice': 'Japanischer Reis',
    'korean_chicken_garnish_fries': 'Pommes Frites',
    'korean_chicken_choose_sauce': 'Wähle deine Soße',
    'korean_chicken_sauce_sweet_sour': 'Süßsauer',
    'korean_chicken_sauce_honey_mustard': 'Honig-Senf',
    'korean_chicken_sauce_yogurt': 'Joghurt',
    'salad_choose_protein': 'Wähle dein Protein',
    'salad_protein_veggie': 'Vegetarisch (ohne tierisches Eiweiß)',
    'salad_protein_mix': 'Mix: Hähnchen + Garnelen',
    'salad_cesar_card': 'Caesar-Salat',
    'salad_classic_card': 'Classic-Salat',
    'salad_crispy_card': 'Crispy-Salat',
    'salad_fruta_card': 'Obstsalat',
    'salad_malaysia_card': 'Malaysia-Salat',
    'salad_thailandia_card': 'Thai-Salat',
    ...
    'table': 'Tisch',
    'ordering_from_table': 'Sie bestellen von Tisch',
    ...
    'notes_placeholder': 'Ohne Zwiebel, extra scharf, usw...',
    'processing': 'VERARBEITUNG...',
    'order_to_table': 'AN TISCH BESTELLEN',
    'place_order': 'BESTELLUNG AUFGEBEN',
    'pay_at_restaurant': 'Bezahlen Sie im Restaurant bei der Abholung',
    'order_sent_to_kitchen': 'Ihre Bestellung wird direkt an die Küche gesendet · Bezahlen Sie den Kellner',
    'service_unavailable': 'Service nicht verfügbar',
    'service_unavailable_desc': 'Dieser Service ist vorübergehend deaktiviert, derzeit bieten wir nur Abholservice im Restaurant an',
    'order_received': 'Ihre Bestellung wurde empfangen und wird zubereitet.',
    'order_received_table': 'Ihre Bestellung für Tisch {table} wurde empfangen.',
    'order_processed': 'Bestellung bearbeitet!',
    'order_notify': 'Wir benachrichtigen Sie, wenn sie fertig ist.',
    'order_error': 'Es gab ein Problem bei der Verarbeitung Ihrer Bestellung. Bitte versuchen Sie es erneut.',
    'cart_empty_error': 'Der Warenkorb ist leer',
    'select_order_type': 'Bitte wählen Sie die Bestellart',
    'your_full_name': 'Ihr vollständiger Name',
    'phone_placeholder': 'Telefonnummer',
    'customize': 'Anpassen',
    'from_price': 'Ab 10,60€',
    'variant_edamame': 'Edamame',
    'variant_edamame_spicy': 'Edamame Scharf (+0,20€)',
    'variant_fried': 'Frittiert',
    'variant_grilled': 'Gegrillt',
    'variant_1_unit': '1 Stück',
    'variant_2_units': '2 Stück',
    'variant_gyozas': 'Garnelen-Gyoza (6 Stk)',
    'variant_pinchito_shrimp': 'Garnelenspieß',
    'variant_pinchito_chicken': 'Hähnchenspieß',
    'soup_chicken_label': 'Hähnchen',
    'soup_prawn_label': 'Garnele',
    'soup_veggie_label': 'Veggie',
    'noodles_pad_thai': 'Pad Thai (Breit)',
    'noodles_finos_card': 'Nudeln (Dünn)',
    'noodles_glass_card': 'Glasnudeln',
    'noodles_udon_card': 'Udon',
    'rice_fried_thai': 'Thai Bratreis',
    'rice_fried_card': 'Gebratener Reis',
    'rice_curry_card': 'Curry-Reis',
  ...
  ru: {
    ...
    'error_variant_not_found': 'Не удалось найти этот вариант. Попробуйте ещё раз.',
    'error_loading_variants': 'Не удалось загрузить варианты. Перезагрузите страницу.',
    ...
    'salad_protein_chicken': 'С курицей',
    'salad_protein_chicken_desc': 'Салат с нежной курицей',
    'salad_protein_shrimp': 'С креветками',
    ...
    'tonkatsu_garnish_fried_noodles': 'Жареная лапша',
    'tonkatsu_choose_sauce': 'Выберите соус',
    'tonkatsu_sauce_sweet_sour': 'Кисло-сладкий',
    'tonkatsu_sauce_bbq': 'Барбекю',
    'korean_chicken_choose_garnish': 'Выберите гарнир',
    'korean_chicken_garnish_white_rice': 'Белый рис',
    'korean_chicken_garnish_japanese_rice': 'Японский рис',
    'korean_chicken_garnish_fries': 'Картофель фри',
    'korean_chicken_choose_sauce': 'Выберите соус',
    'korean_chicken_sauce_sweet_sour': 'Кисло-сладкий',
    'korean_chicken_sauce_honey_mustard': 'Медово-горчичный',
    'korean_chicken_sauce_yogurt': 'Йогурт',
    'salad_choose_protein': 'Выберите белок',
    'salad_protein_veggie': 'Вегетарианский (без животного белка)',
    'salad_protein_mix': 'Микс: курица + креветки',
    'salad_cesar_card': 'Салат Цезарь',
    'salad_classic_card': 'Классический салат',
    'salad_crispy_card': 'Салат Криспи',
    'salad_fruta_card': 'Фруктовый салат',
    'salad_malaysia_card': 'Малайзийский салат',
    'salad_thailandia_card': 'Тайский салат',
    ...
    'table': 'Стол',
    'ordering_from_table': 'Вы заказываете со Стола',
    ...
    'notes_placeholder': 'Без лука, очень острое и т.д...',
    'processing': 'ОБРАБОТКА...',
    'order_to_table': 'ЗАКАЗ НА СТОЛ',
    'place_order': 'ОФОРМИТЬ ЗАКАЗ',
    'pay_at_restaurant': 'Оплатите в ресторане при получении заказа',
    'order_sent_to_kitchen': 'Ваш заказ будет отправлен на кухню · Оплатите официанту',
    'service_unavailable': 'Сервис недоступен',
    'service_unavailable_desc': 'Этот сервис временно отключён, в настоящее время доступен только самовывоз в ресторане',
    'order_received': 'Ваш заказ получен и готовится.',
    'order_received_table': 'Ваш заказ для Стола {table} получен.',
    'order_processed': 'Заказ оформлен!',
    'order_notify': 'Мы уведомим вас, когда он будет готов.',
    'order_error': 'Произошла ошибка при обработке заказа. Пожалуйста, попробуйте снова.',
    'cart_empty_error': 'Корзина пуста',
    'select_order_type': 'Пожалуйста, выберите тип заказа',
    'your_full_name': 'Ваше полное имя',
    'phone_placeholder': 'Номер телефона',
    'customize': 'Настроить',
    'from_price': 'От 10,60€',
    'variant_edamame': 'Эдамамэ',
    'variant_edamame_spicy': 'Эдамамэ острый (+0,20€)',
    'variant_fried': 'Жареные',
    'variant_grilled': 'На гриле',
    'variant_1_unit': '1 шт.',
    'variant_2_units': '2 шт.',
    'variant_gyozas': 'Гёдза с креветками (6 шт)',
    'variant_pinchito_shrimp': 'Шашлык из креветок',
    'variant_pinchito_chicken': 'Шашлык из курицы',
    'soup_chicken_label': 'Курица',
    'soup_prawn_label': 'Креветка',
    'soup_veggie_label': 'Вегетарианский',
    'noodles_pad_thai': 'Пад Тай (Широкая)',
    'noodles_finos_card': 'Лапша (Тонкая)',
    'noodles_glass_card': 'Стеклянная',
    'noodles_udon_card': 'Удон',
    'rice_fried_thai': 'Тайский жареный рис',
    'rice_fried_card': 'Жареный рис',
    'rice_curry_card': 'Рис с карри',
