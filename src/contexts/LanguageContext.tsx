...
const translations = {
  es: {
    ...
    'salad_thai_ingredients': 'Lechuga, Cacahuete, noodles, lima, sésamo, ternera al wok, salsa vinagreta y salsa césar',
  ...
  en: {
    ...
    'salad_thai_ingredients': 'Lettuce, Peanut, noodles, lime, sesame, wok beef, vinaigrette and caesar sauce',
  ...
  fr: {
    ...
    'salad_thai_ingredients': 'Laitue, Cacahuète, nouilles, citron vert, sésame, bœuf au wok, vinaigrette et sauce césar',
